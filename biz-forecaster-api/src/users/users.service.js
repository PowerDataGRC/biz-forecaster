...
let UsersService = class UsersService {
    constructor(usersRepository, tenantsService) {
    ...
    async createFromRegistration(params) {
        ...
        if (!tenant) {
            throw new common_1.NotFoundException(`Tenant with ID "${params.tenantId}" not found.`);
        }
